...
function FAQ(props) {
    return (
        ...
        <div className='sm:w-[70%] w-[90%] m-auto mt-12 mb-12 border-2 p-4 rounded-lg'>
            <ChakraProvider>
        ...
        <div className=' w-[90%] sm:w-[50%] m-auto mb-8'>
            <p className='text-center text-xl sm:text-2xl font-medium mb-4'>SUBSCRIBE FOR FREEBIES </p>
            <p className='text-center text-base sm:text-xl w-[70%] m-auto'>Drop your mail to get notified of our juicy discount rates, giveaways and updates on how to serve you better. </p>
        ...
        <div className='w-[70%] m-auto mt-12 text-center'>
            ...
            <p className='font-medium text-base sm:text-xl mt-4 w-[90%] sm:w-[75%] leading-normal m-auto'>
