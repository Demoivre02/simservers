        ...
        <>
            <div className='flex  justify-between p-8'>
                <div  className='  '>
                    ...
                    <div style={{color: "#333333"}}  className='track-3 lg:w-[50%]  text-{#949BA5} xl:w-[35%] ml-14 text-xl'>
                    Simservers.io, a fully automated platform
                    conceived to help you automated your Recharge
                    and Data Business.
                    </div>
                </div>
                <div className='flex w-[45%]  mr-8 justify-around items-center'>   
            ...
            <hr />
            <div className='flex justify-between m-auto mt-8 mb-4  w-11/12'>
                <p style={{color: "#333333"}} className='ml-5 text-base font-medium'>© SIMSERVERS.IO. All Rights Reserves</p>
                <div className='flex justify-between w-[10%] mr-6'>
